...
const sql: string = `
    ...
    VALUES
        ('Casa', 'Edificação principal da fazenda, destinada à moradia dos proprietários e recepção de hóspedes'),
        ...
        ('Pasto01', 'Área de pastagem delimitada, coberta por vegetação destinada à alimentação e ao manejo do gado'),
        ('Pasto02', 'Setor secundário de pastagem para rotação do rebanho e conservação do solo'),
        ('Cercado', 'destinada a conter animais de criação, isolar plantações ou dividir pastagens');
`
